...
# BEGIN 01E SOLUTION
line_count = len(zen_of_python.splitlines())
avg_num_chunks_per_line = num_char_chunks // line_count
...
# BEGIN 01F SOLUTION
zen_of_python_uniqname = zen_of_python.replace('Dutch', 'wningyua@umich.edu')
